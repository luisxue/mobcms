...
'license'=>'<div class="license"><h1>系统安装协议</h1>
                ...
                <p align=right>微信商家营销管理系统微信平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微信商家营销管理系统微信公共平台V'.SOFT_VERSION.' 安装程序',
...
$form_db_init_items = array(
	...
	'admininfo' => array(
		'username' => array('type' => 'text', 'required' => 1, 'reg' => '/^.*$/', 'value' => array('type' => 'var', 'var' => 'admin')),
...
?>
			<div class="footer">
			    <p>Powered by 微信商家营销管理系统微信公共平台© v1.01 2012-2013</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
