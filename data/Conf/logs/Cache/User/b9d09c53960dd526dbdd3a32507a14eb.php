...
<div class="cLineB">
  <h4>关键词分类管理 <span class="FAQ">设置分类有助于管理检索，也可以不设置</span></h4>
  
 </div>
         <div class="cLineC" style="line-height: 32px;">
 <a  href="<?php echo U('Text_cate/add');?>" class="btnGrayS vm bigbtn" >添加关键词分类</a>　 
</div>
...
<td class="norightborder">
	<!--a target="ddd" href="<?php echo U('Wap/Index/Text_cate',array('token'=>$_SESSION['token']));?>">查看</a-->
	<a target="ddd" href="<?php echo U('Text_cate/edit',array('id'=>$vo['id']));?>">编辑</a>	
	<a href="javascript:drop_confirm('您确定要删除吗? 删除将无法恢复！', '<?php echo U('Text_cate/del',array('id'=>$vo['id']));?>');">删除</a>
</td>
</tr>
<?php if(is_array($vo['sub'])): $i = 0; $__LIST__ = $vo['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
		...
		<td class="norightborder">
			<!--a target="ddd" href="<?php echo U('Wap/Index/Text_cate',array('token'=>$_SESSION['token']));?>">查看</a-->
			<a target="ddd" href="<?php echo U('Text_cate/edit',array('id'=>$v['id']));?>">编辑</a>
			<a href="javascript:drop_confirm('您确定要删除吗? 删除将无法恢复！', '<?php echo U('Text_cate/del',array('id'=>$v['id']));?>');">删除</a>
		</td>
