...
<div id="Frame" class="shadow">
	<div id="nav">  
        ...
        <?php }else{ ?>
			...
			<li><strong>等级：</strong><strong style="color:#CC3300;" ><?php echo ($userinfo["name"]); ?>(VIP<?php if($_SESSION['gid']>1){echo $_SESSION['gid']-1;}else{echo 0;} ?>)</strong></li>
        <?php } ?>
		</ul>
		<ul class="ul2" >
	...
	<div id="Menu">
		<div class="top">
             <img style="display:none;" src="<?php echo RES;?>/images/TwoMenu-ico-006.png" />
            <a>管理平台</a>
            <span>
		...
		<div class="ThreeMenu">
        	<div class="contab" style="display:block;" >
			 	<a href="<?php echo U('Index/index');?>" class="Red" >
                    <img src="<?php echo RES;?>/images/1-1.png" /><span>公众账号</span>
                </a>
                <a href="<?php echo U('Index/data');?>" class="Highland" >
                	<img src="<?php echo RES;?>/images/TwoMenu-ico-03.png" /><span>用户中心</span>
                </a>               
                <a href="<?php echo U('Index/add');?>" class="Navy" >
                    <img src="<?php echo RES;?>/images/1-2.png" /><span>添加公号</span>
                </a>
                <a href="index.php?g=Home&m=Index&a=help" class="DarkGreen" >
                    <img src="<?php echo RES;?>/images/3-2.png" /><span>帮助文档</span>
                </a>
            </div>
		</div>
	</div>
...
<li style="height:47px;line-height:47px;color:red;padding:10px;">请添加公众帐号,点击进入<strong>功能管理</strong>设置</li>
</ul>
      </div>
              ...
              <TBODY>
                <TR></TR>                
                 <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><TR>
					  <TD><p><a href="<?php echo U('Function/index',array('id'=>$vo['id'],'token'=>$vo['token']));?>" title="点击进入功能管理"></a></p><p><?php echo ($vo["wxname"]); ?></p></TD>
					  ...
					  <TD class="norightborder">　<a href="<?php echo U('Index/edit',array('id'=>$vo['id']));?>">编辑</a>　<a onclick="return confirm('你真的要删除吗，删除后您所配置的所有信息将全部被删除,无法恢复？') ? true : false" href="<?php echo U('Index/del',array('id'=>$vo['id']));?>">删除</a>　
