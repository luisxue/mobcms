	...
	<div class="loginBox">
			...
			<div class="content">
            	<form name="form1" method="post" action="<?php echo U('Admin/insert');?>" id="form1" class="myform">
                	...
                	<fieldset>
                		<legend style="width:auto;"><h1 style="font-size: 25px;color: #0C9DEE; margin-left: 55px;">微动CMS_Alivv</h1></legend>
                    	...
                    	<p>
                        	...
                        	<span class="chk_img"><img style="width: 65px;height: 30px;" src="<?php echo U('Admin/verify');?>" onclick="javascript:this.src='./?a=verify&m=Index&tm='+Math.random()" id="imgCheckB"/></span>
                            <span class="chk_txt" onclick="javascript:this.src='./?a=verify&m=Index&tm='+Math.random()"><a href="javascript:refresh();"  style="color: #0033CC">看不清？点图片</a></span>
                        </p>
...
<div class="footer pt30">
	CopyRight &copy 2013 微信商家营销管理系统 All Rights Reserved 版权所有<br />
